...
export const About = () => {
  const features = [
    {
      icon: <Check className="w-6 h-6 text-[#FEF7CD]" />,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-primary">
            Why Choose <span className="text-[#FEF7CD]">CASA</span>?
          </h2>
